...
1.  If we want to execute automation scripts, we have to run the following command in command line.

 <!-- npx cypress open  -->

2.  Cypress Window launches automatically then click on E2E testing.

3.  It re-directs to a new window which consists browsers, we have to select a browser to run our scripts.
    ex: chrome

4.  After that we are re-directed to cypress runner window, In that window we can see the list of autoamtion scripts.

5.  Click on the script that needs to be execute.
